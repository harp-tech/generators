...
namespace Harp.Generators.Tests
{
    ...
    public partial class AnalogData
    {
        ...
        static float[] FormatPayload(AnalogDataPayload value)
        {
            ...
            PayloadMarshal.Write(result, 3, 3, value.Accelerometer);
            return result;
        }
    ...
    public partial class ComplexConfiguration
    {
        ...
        static ComplexConfigurationPayload ParsePayload(byte[] payload)
        {
            ...
            result.DutyCycle = PayloadMarshal.ReadSingle(payload, 4);
            result.Frequency = PayloadMarshal.ReadSingle(payload, 8);
            result.EventsEnabled = payload[12] != 0;
            result.Delta = PayloadMarshal.ReadUInt32(payload, 13);
            return result;
        }
        ...
        static byte[] FormatPayload(ComplexConfigurationPayload value)
        {
            ...
            PayloadMarshal.Write(result, 4, value.DutyCycle);
            PayloadMarshal.Write(result, 8, value.Frequency);
            result[12] = (byte)(value.EventsEnabled ? 1 : 0);
            PayloadMarshal.Write(result, 13, value.Delta);
            return result;
        }
    ...
    public partial class Version
    {
        ...
        static VersionPayload ParsePayload(byte[] payload)
        {
            ...
            result.ProtocolVersion = PayloadMarshal.ReadHarpVersion(payload, 0);
            result.FirmwareVersion = PayloadMarshal.ReadHarpVersion(payload, 3);
            result.HardwareVersion = PayloadMarshal.ReadHarpVersion(payload, 6);
            result.CoreId = PayloadMarshal.ReadUtf8String(payload, 9, 3);
        ...
        static byte[] FormatPayload(VersionPayload value)
        {
            byte[] result;
            result = new byte[32];
            PayloadMarshal.Write(result, 0, 3, value.ProtocolVersion);
            PayloadMarshal.Write(result, 3, 3, value.FirmwareVersion);
            PayloadMarshal.Write(result, 6, 3, value.HardwareVersion);
            PayloadMarshal.Write(result, 9, 3, value.CoreId);
            PayloadMarshal.Write(result, 12, 20, value.InterfaceHash);
            return result;
        }
    ...
    public partial class CustomRawPayload
    {
        ...
        public static HarpVersion GetPayload(HarpMessage message)
        {
            ...
            return ParsePayload(payload.Array!, payload.Offset, payload.Count);
        }
    ...
    public partial class CustomMemberConverter
    {
        ...
        static CustomMemberConverterPayload ParsePayload(byte[] payload)
        {
            ...
            result.Data = ParsePayloadData(payload, 1, 2);
            return result;
        }
        ...
        static byte[] FormatPayload(CustomMemberConverterPayload value)
        {
            ...
            PayloadMarshal.Write(result, 1, 2, FormatPayloadData(value.Data));
            return result;
        }
    ...
    public partial class MixedMemberLength
    {
        ...
        static byte[] FormatPayload(MixedMemberLengthPayload value)
        {
            ...
            PayloadMarshal.Write(result, 1, 1, value.Single);
            PayloadMarshal.Write(result, 2, 2, value.Multiple);
            return result;
        }
    ...
    public partial class CreateVersionPayload
    {
        ...
        /// </summary>
        [Description("")]
        public HarpVersion ProtocolVersion { get; set; } = new();

        /// <summary>
        /// Gets or sets a value to write on payload member FirmwareVersion.
        /// </summary>
        [Description("")]
        public HarpVersion FirmwareVersion { get; set; } = new();

        /// <summary>
        /// Gets or sets a value to write on payload member HardwareVersion.
        /// </summary>
        [Description("")]
        public HarpVersion HardwareVersion { get; set; } = new();
        ...
        /// </summary>
        [Description("")]
        public byte[] InterfaceHash { get; set; } = new byte[20];
    ...
    public partial class CreateCustomPayloadPayload
    {
        ...
        public HarpVersion CustomPayload { get; set; } = new();
    ...
    public partial class CreateCustomRawPayloadPayload
    {
        ...
        public HarpVersion CustomRawPayload { get; set; } = new();
    ...
    public partial class CreateMultiElementPayloadPayload
    {
        ...
        public ushort[] MultiElementPayload { get; set; } = new ushort[3];
    ...
    public partial class CreateSingleElementPayloadPayload
    {
        ...
        public ushort[] SingleElementPayload { get; set; } = new ushort[1];
    ...
    public partial class CreateMixedMemberLengthPayload
    {
        ...
        /// </summary>
        [Description("")]
        public byte[] Single { get; set; } = new byte[1];

        /// <summary>
        /// Gets or sets a value to write on payload member Multiple.
        /// </summary>
        [Description("")]
        public byte[] Multiple { get; set; } = new byte[2];
